...
class _StudentListScreenState extends State<StudentListScreen> {
      ...
      if (userId != null) {
        ...
        for (var student in students) {
          if (student.schoolID != null &&
              !schoolNames.containsKey(student.schoolID)) {
            schoolNames[student.schoolID] =
                await firestoreService.getSchoolName(student.schoolID);
          }

          if (student.elhalagatID != null &&
              !halagaNames.containsKey(student.elhalagatID)) {
            halagaNames[student.elhalagatID] =
                await firestoreService.getHalagaName(student.elhalagatID);
          }
        }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('قائمة الأبناء',
            style: TextStyle(
                fontFamily: 'RB',
        ...
        child: _isLoading
            ? const Center(
                child: CircularProgressIndicator(
                    valueColor:
                        AlwaysStoppedAnimation<Color>(Color(0xFF017546))))
            : _students.isEmpty
                ? Center(
                    child: Container(
                        ...
                        children: [
                          ...
                          ElevatedButton(
                            ...
                            child: const Text('إعادة المحاولة',
                                style:
                                    TextStyle(fontFamily: 'RB', fontSize: 16)),
                          ),
                        ],
                      ),
                    ),
                                ...
                                children: [
                                  ...
                                  Container(
                                    ...
                                    child: Icon(Icons.arrow_forward_ios,
                                        size: 16, color: Color(0xFF017546)),
                                  ),
                                ],
                              ),
                            ),
